...
class DPS_refine(Base_Algo):
    ...
    @ torch.enable_grad()
    def cal_x0(self, xt, t, at, at_next, x_0, noise='ddpm', classes=None):
        ...
        x0_t -= 1 / at_next.sqrt() * grad * self.lam / loss.sqrt() #* torch.exp(-3*(1000-t)/1000)
        return x0_t, add_up
